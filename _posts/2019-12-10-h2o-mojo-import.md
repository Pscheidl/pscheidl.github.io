...
![Importing MOJO in Flow - Part 1](https://www.pavel.cool/images/mojo_import/mojo_import_1.png)
...
![Importing MOJO in Flow - part 2](https://www.pavel.cool/images/mojo_import/mojo_import_2.png)

Notice the `predict` button is active - users are able to make predictions with imported MOJO models.

![Importing MOJO in Flow - part 2](https://www.pavel.cool/images/mojo_import/mojo_import_3.png)
